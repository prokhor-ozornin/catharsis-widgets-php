...
final class GoogleScriptsTraitTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_google_method()
  {
    ...
    $this->assertEquals("<script src=\"{$scripts_path}/google_analytics.js\" type=\"text/javascript\"></script><script src=\"{$scripts_path}/google_plusone.js\" type=\"text/javascript\"></script>", self::google());
  }
}