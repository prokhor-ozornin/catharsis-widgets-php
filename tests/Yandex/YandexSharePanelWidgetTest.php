...
final class YandexSharePanelWidgetTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_constructors()
  {
    ...
    $this->assertAttributeEquals(Catharsis\Web\YandexSharePanelLayout::Button, "layout", $widget);
    $this->assertAttributeEquals(array("yaru", "vkontakte", "facebook", "twitter", "odnoklassniki", "moimir", "lj", "friendfeed", "moikrug", "gplus", "pinterest", "surfingbird"), "services", $widget);
  }
  ...
  public function test_services_method()
  {
    ...
    $this->assertAttributeEquals(array("service"), "services", $widget);
  }
  ...
  {
    $widget = new Catharsis\Web\YandexSharePanelWidget();
    $this->assertEquals("<div class=\"yashare-auto-init\" data-yashareL10n=\"{$widget->user_language()}\" data-yashareQuickServices=\"yaru,vkontakte,facebook,twitter,odnoklassniki,moimir,lj,friendfeed,moikrug,gplus,pinterest,surfingbird\" data-yashareType=\"button\"></div>", (string) $widget);

    $widget = new Catharsis\Web\YandexSharePanelWidget();
    $this->assertEquals('<div class="yashare-auto-init" data-yashareL10n="ru" data-yashareQuickServices="yaru" data-yashareType="link"></div>', (string) $widget->services("yaru")->layout(Catharsis\Web\YandexSharePanelLayout::Link)->language("ru"));
  }
}