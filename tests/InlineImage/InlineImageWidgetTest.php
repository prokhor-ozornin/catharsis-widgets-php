...
final class InlineImageWidgetTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_constructors()
    {
        ...
        $this->assertAttributeEmpty("_contents", $widget);
    ...
    public function test_contents_method()
    {
        ...
        $this->assertAttributeEquals("contents", "_contents", $widget);
    }
    ...
    public function test_toString_method()
    {
        ...
        $widget = new Catharsis\Web\InlineImageWidget();
        $this->assertEquals("<img src=\"data:image;base64,{$base64_image_data}\"></img>",
                            (string) $widget->contents($image_data));

        $widget = new Catharsis\Web\InlineImageWidget();
        $this->assertEquals("<img src=\"data:jpg;base64,{$base64_image_data}\"></img>",
