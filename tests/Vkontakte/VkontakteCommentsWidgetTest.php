...
final class VkontakteCommentsWidgetTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_constructors()
  {
    ...
    $this->assertAttributeEmpty("attach", $widget);
    $this->assertAttributeEquals(Catharsis\Web\VkontakteCommentsLimit::Limit5, "limit", $widget);
    $this->assertAttributeEmpty("width", $widget);
  }

  /**
   ** Performs testing of {@link Catharsis\Web\VkontakteCommentsWidget::attach(array $attach)} method.
   */
  public function test_attach_method()
  {
    ...
    $this->assertAttributeEquals(array("attach"), "attach", $widget);
  }
  ...
  public function test_limit_method()
  {
    ...
    $this->assertAttributeEquals(0, "limit", $widget);
  }
