...
final class VideoJSPlayerWidgetTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_constructors()
  {
    ...
    $this->assertAttributeEmpty("extra", $widget);
    $this->assertAttributeEmpty("height", $widget);
    $this->assertAttributeEmpty("videos", $widget);
  ...
  public function test_extra_method()
  {
    ...
    $this->assertAttributeEquals("extra", "extra", $widget);
  }
  ...
  public function test_videos_method()
  {
    ...
    $this->assertAttributeEquals(array("video"), "videos", $widget);
  }
  ...
  public function test_toString_method()
  {
    ...
    $videos = array("http://vjs.zencdn.net/v/oceans.mp4" => Catharsis\Web\VideoContentTypes::MP4, "http://vjs.zencdn.net/v/oceans.webm" => Catharsis\Web\VideoContentTypes::WebM);
