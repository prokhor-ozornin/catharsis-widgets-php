...
final class TumblrShareButtonWidgetTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_constructors()
    {
        ...
        $this->assertAttributeEquals(Catharsis\Web\TumblrShareButtonType::First, "_type", $widget);
    }
    ...
    public function test_type_method()
    {
        ...
        $this->assertAttributeEquals(0, "_type", $widget);
    }
    ...
    {
        $widget = new Catharsis\Web\TumblrShareButtonWidget();
        $this->assertEquals('<a href="http://www.tumblr.com/share" style="display:inline-block; text-indent:-9999px; overflow:hidden; width:80px; height:20px; background:url(&#039;http://platform.tumblr.com/v1/share_1.png&#039;) top left no-repeat transparent;" title="Share on Tumblr">Share on Tumblr</a>',
                            (string) $widget);

        $widget = new Catharsis\Web\TumblrShareButtonWidget();
        $this->assertEquals('<a href="http://www.tumblr.com/share" style="display:inline-block; text-indent:-9999px; overflow:hidden; width:70px; height:20px; background:url(&#039;http://platform.tumblr.com/v1/share_2T.png&#039;) top left no-repeat transparent;" title="Share on Tumblr">Share on Tumblr</a>',
                            (string) $widget->type(Catharsis\Web\TumblrShareButtonType::Second)->colorScheme(Catharsis\Web\TumblrShareButtonColorScheme::Gray));
    }
}
