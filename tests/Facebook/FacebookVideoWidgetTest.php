...
final class FacebookVideoWidgetTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_toString_method()
  {
    ...
    $widget = new Catharsis\Web\FacebookVideoWidget();
    $this->assertEquals('<iframe allowfullscreen="true" frameborder="0" height="height" mozallowfullscreen="true" src="http://www.facebook.com/video/embed?video_id=id" webkitallowfullscreen="true" width="width"></iframe>', (string) $widget->id("id")->width("width")->height("height"));
  }
}