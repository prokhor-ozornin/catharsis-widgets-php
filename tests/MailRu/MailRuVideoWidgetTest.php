...
final class MailRuVideoWidgetTest extends PHPUnit_Framework_TestCase
{
  ...
  public function test_toString_method()
  {
    ...
    $widget = new Catharsis\Web\MailRuVideoWidget();
    $this->assertEquals('<iframe allowfullscreen="true" frameborder="0" height="height" mozallowfullscreen="true" src="http://api.video.mail.ru/videos/embed/mail/id" webkitallowfullscreen="true" width="width"></iframe>', (string) $widget->id("id")->height("height")->width("width"));
  }
}