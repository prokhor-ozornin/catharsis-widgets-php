...
class CackleCommentsWidget extends HtmlWidget
{
    ...
    public function __toString()
    {
        ...
        $config = array("widget" => "Comment", "id" => $this->_account);
        $config_json = json_encode($config, JSON_FORCE_OBJECT);

        return "<div id=\"mc-container\"></div>" . self::javascriptInline("cackle_widget = window.cackle_widget || [];cackle_widget.push($config_json);") . "<a id=\"mc-link\" href=\"http://cackle.me\">Социальные комментарии <b style=\"color:#4FA3DA\">Cackl</b><b style=\"color:#F65077\">e</b></a>";
    }
}
