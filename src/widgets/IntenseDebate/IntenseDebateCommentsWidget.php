 ...
 */
class IntenseDebateCommentsWidget extends HtmlWidgetBase
{
  private $account;
  private $post_id;
  private $post_title;
   ...
   * @param string $post_id Identifier of post or page.
   * @return \Catharsis\Web\IntenseDebateCommentsWidget Reference to the current widget.
   */
   ...
   * @param string $post_url URL of post or page.
   * @return \Catharsis\Web\IntenseDebateCommentsWidget Reference to the current widget.
   */
   ...
   * @param string $post_title Title of post or page.
   * @return \Catharsis\Web\IntenseDebateCommentsWidget Reference to the current widget.
   */
  ...
  public function __toString()
  {
    ...
    return "<script type=\"text/javascript\">var idcomments_acct = \"{$this->account}\"; var idcomments_post_id = \"{$this->post_id}\"; var idcomments_post_url = \"{$this->post_url}\"; var idcomments_post_title = \"{$this->post_title}\";</script><span id=\"IDCommentsPostTitle\" style=\"display:none\"></span><script src=\"http://www.intensedebate.com/js/genericCommentWrapperV2.js\" type=\"text/javascript\"></script>";
  }
}