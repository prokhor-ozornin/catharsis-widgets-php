...
trait HtmlHelpersTrait
{
   ...
   */
  public static function css_inline($code)
  {
    return self::html_tag("style", array("type" => "text/css"), (string) $code);
  }
   ...
   * @return string CSS tag string.
   */
  public static function css_link($url)
  {
    if (empty($url))
    {
      return "";
    ...
    return self::html_tag("link", array("href" => (string) $url, "rel" => "stylesheet", "type" => "text/css"));
  }
   ...
   */
  public static function html_tag($tag, $attributes = array(), $body = "")
  {
    if (empty($tag))
    {
      return "";
    ...
    $attributes_string = empty($attributes_pairs) ? "" : " ".implode(" ", $attributes_pairs);
   ...
   */
  public static function javascript_inline($code)
  {
    return self::html_tag("script", array("type" => "text/javascript"), (string) $code);
  }
   ...
   * @return string JavaScript tag string.
   */
  public static function javascript_link($url)
  {
    if (empty($url))
    {
      return "";
    ...
    return self::html_tag("script", array("src" => (string) $url, "type" => "text/javascript"));
  }
   ...
   */
  public static function url_query($parameters)
  {
